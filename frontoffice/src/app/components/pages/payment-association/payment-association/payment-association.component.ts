...
import {association_payment} from "../../../../_models/association_payment";
import {association_paymentService} from "../../../../_services/association_paymentService";
...
export class PaymentAssociationComponent implements OnInit {
  ...
  getNonPayers(){
    this.PaymentService.getNonPayers().subscribe( res => this.listPayment = res)
  }
  getSusceptible(){
    this.PaymentService.getSusceptible().subscribe( res => this.listPayment = res)
  }
  getRisqueLevel(idC:any){
    this.PaymentService.getRisqueLevel(idC)
  }
